...
<script type="text/javascript">
	...
	function yearRevenue() {
		...
		var yearcallback = function(returndata){ 
			...
			vuearea.html_head = "<th scope=\"col\"></th>";
			vuearea.html_body1 = "<td>당기순이익</td>";	
			vuearea.html_body2 = "<td>영업이익</td>";	
			vuearea.html_body3 = "<td>매출</td>";	
			vuearea.html_body4 = "<td>인건비</td>";	
			vuearea.html_body5 = "<td>기타지출</td>";	
			vuearea.html_body6 = "<td>전년대비매출성장률</td>";	
			vuearea.html_body7 = "<td>전년대비순이익성장률</td>";
			...
			console.log(vuearea.html_body1);			
			...
			//vuearea.grouplist = returndata.result1;
			console.log(returndata.result1);
			vuearea.grouplist = returndata.result1;
			}
			}

		callAjax("/sales/vueYearRevenue.do", "post", "json", "false", param, yearcallback);
					...
					<div class="content">
						...
						<p class="Location">
							<a href="../dashboard/dashboard.do" class="btn_set home">메인으로</a> <span
								...
								</span> <a href="../sales/vueYyRevenue.do" class="btn_set refresh">새로고침</a>
						</p>
